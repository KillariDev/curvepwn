...
\title{Report: flaws in the Curve pools contracts logic}
...
\begin{document}
    ...
    \subsection{Loss of traders funds via back and forth trades}
    ...
    \subsection{Small profits from adding and withdrawing liquidity in sequence}
